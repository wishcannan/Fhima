...
$(document).ready(function() {
	...
	$('#frame_turn').on('click', '#choose_card_1', function(e) {
		e.preventDefault();
		delayLoad('#frame_turn', 1000, 'aboutme.html');
	});
	
	$('#frame_turn').on('click', '#choose_card_2', function(e) {
		e.preventDefault();
		delayLoad('#frame_turn', 1000, 'message.html');
	});
	...
	$('#ann_added_frame').on('click', '#icon_home', function(e) {
		e.preventDefault();
		delayLoad('#frame_turn', 500, 'home.html');
	});
});
...
/* PowerTip -> */
$(document).ready(function() {
	$("*[title]").powerTip({followMouse: true});
});
/* <- PowerTip */
